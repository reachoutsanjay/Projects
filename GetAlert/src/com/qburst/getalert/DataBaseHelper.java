...
private static String DB_PATH = "/data/data/com.qburst.getalert/databases/";
 
private static String DB_NAME = "GetAlertdb.sqlite";
...
checkDB = SQLiteDatabase.openDatabase(myPath, null, SQLiteDatabase.NO_LOCALIZED_COLLATORS | SQLiteDatabase.CREATE_IF_NECESSARY);
    ...
    Log.i("Hellloooo No Data Base", e.getMessage());
